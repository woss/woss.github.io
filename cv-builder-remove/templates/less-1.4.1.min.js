 ...
 */ (function (e, t) {
  ...
  function m() {
    ...
    for (var t = 0; t < e.length; t++)
      if (e[t].type.match(p)) {
        ...
        (n.filename = document.location.href.replace(/#.*$/, '')),
          new r.Parser(n).parse(e[t].innerHTML || '', function (n, i) {
  ...
  function w(t, n, i, s) {
    var o = b(t.href, e.location.href),
      ...
      c = { css: a, timestamp: f },
      h,
      p = { relativeUrls: r.relativeUrls, currentDirectory: o.path, filename: u };
    t instanceof r.tree.parseEnv
      ? ((h = new r.tree.parseEnv(t)),
        (p.entryPath = h.currentFileInfo.entryPath),
        (p.rootpath = h.currentFileInfo.rootpath),
        (p.rootFilename = h.currentFileInfo.rootFilename))
      : ((h = new r.tree.parseEnv(r)),
        (h.mime = t.type),
        (p.entryPath = o.path),
        (p.rootpath = r.rootpath || o.path),
        (p.rootFilename = u)),
      h.relativeUrls &&
        (r.rootpath ? (p.rootpath = b(r.rootpath + y(o.path, p.entryPath)).path) : (p.rootpath = o.path)),
      x(
        u,
        t.type,
        function (e, a) {
          ...
          if (!i && c && a && new Date(a).valueOf() === new Date(c.timestamp).valueOf())
            S(c.css, t), n(null, null, e, t, { local: !0, remaining: s }, u);
          else
            try {
              (h.contents[u] = e),
                (h.paths = [o.path]),
                (h.currentFileInfo = p),
                new r.Parser(h).parse(e, function (r, i) {
                  if (r) return n(r, null, null, t);
                  try {
                    n(r, i, e, t, { local: !1, lastModified: a, remaining: s }, u),
                      h.currentFileInfo.rootFilename === u && N(document.getElementById('less-error-message:' + E(u)));
                  } catch (r) {
                    n(r, null, null, t);
                  }
                });
    ...
    if (u.styleSheet)
      ...
      u.appendChild(document.createTextNode(e)),
        (o =
          ...
          s.firstChild.nodeValue === u.firstChild.nodeValue);
  ...
  function k(e, n) {
    var i = 'less-error-message:' + E(n || ''),
      ...
      c = l.match(/([^\/]+(\?.*)?)$/)[1];
    (o.id = i),
      (o.className = 'less-error-message'),
      (a =
        '<h3>' +
        (e.type || 'Syntax') +
        'Error: ' +
    ...
    var h = function (e, n, r) {
      e.extract[n] != t &&
        f.push(
          s
            .replace(/\{line\}/, (parseInt(e.line) || 0) + (n - 1))
            .replace(/\{class\}/, r)
            .replace(/\{content\}/, e.extract[n]),
        );
    };
    e.extract
      ? (h(e, 0, ''),
        h(e, 1, 'line'),
        h(e, 2, ''),
        (a += 'on line ' + e.line + ', column ' + (e.column + 1) + ':</p>' + '<ul>' + f.join('') + '</ul>'))
      : e.stack && (a += '<br/>' + e.stack.split('\n').slice(1).join('<br/>')),
      (o.innerHTML = a),
      S(
        [
        ...
        (u = setInterval(function () {
          document.body &&
            (document.getElementById(i)
              ? document.body.replaceChild(o, document.getElementById(i))
              : document.body.insertBefore(o, document.body.firstChild),
            clearInterval(u));
        }, 10));
  }
  var r, i, s;
  typeof environment == 'object' && {}.toString.call(environment) === '[object Environment]'
    ? (typeof e == 'undefined' ? (r = {}) : (r = e.less = {}), (i = r.tree = {}), (r.mode = 'rhino'))
    : typeof e == 'undefined'
    ? ((r = exports), (i = n('./tree')), (r.mode = 'node'))
    : (typeof e.less == 'undefined' && (e.less = {}), (r = e.less), (i = e.less.tree = {}), (r.mode = 'browser')),
    (r.Parser = function (t) {
      function m() {
        (a = c[u]), (f = o), (h = o);
      }
      ...
      function E(e) {
        ...
        return (
          (c[u] = c[u].slice(e + (o - i))), (h = o), c[u].length === 0 && u < c.length - 1 && u++, t !== o || n !== u
        );
      }
      function S(e, t) {
        var n = w(e);
      ...
      function N(e, t) {
        return e.filename && t.currentFileInfo.filename && e.filename !== t.currentFileInfo.filename
      ...
      function k(e, t, i) {
        ...
        return (
          r.mode !== 'browser' && r.mode !== 'rhino' && (s = n('path').resolve(s)),
          { lineNumber: C(e, t).line + 1, fileName: s }
        );
      }
      function L(e, t) {
        var n = N(e, t),
        ...
        (this.type = e.type || 'Syntax'),
          ...
          (this.filename = e.filename || t.currentFileInfo.filename),
          (this.index = e.index),
          (this.line = typeof i == 'number' ? i + 1 : null),
          (this.callLine = e.call && C(e.call, n).line + 1),
          (this.callExtract = o[C(e.call, n).line]),
          (this.stack = e.stack),
          (this.column = s),
        ...
        (p = {
            ...
            f.toCSS = (function (e) {
              ...
              return function (s, o) {
                  ...
                  ((o = Object.keys(o).map(function (e) {
                    ...
                    return (
                      t instanceof i.Value ||
                        (t instanceof i.Expression || (t = new i.Expression([t])), (t = new i.Value([t]))),
                      new i.Rule('@' + e, t, !1, 0)
                    );
                  })),
                ...
                return s.yuicompress && r.mode === 'node'
                  ? n('ycssmin').cssmin(l, s.maxLineLen)
                  : s.compress
                  ? l.replace(/(\s)+/g, '$1')
                  : l;
              };
          ...
          parsers: {
            ...
            entities: {
              ...
              literal: function () {
                return (
                  w(this.entities.dimension) ||
                  w(this.entities.color) ||
                  w(this.entities.quoted) ||
                  w(this.entities.unicodeDescriptor)
                );
              },
              assignment: function () {
                var e, t;
              ...
              url: function () {
                ...
                return (
                  (e =
                    w(this.entities.quoted) || w(this.entities.variable) || w(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/) || ''),
                  S(')'),
                  new i.URL(e.value != null || e instanceof i.Variable ? e : new i.Anonymous(e), t.currentFileInfo)
                );
              },
              variable: function () {
                var e,
            ...
            mixin: {
              call: function () {
                ...
                w('(') && ((u = this.mixin.args.call(this, !0).args), S(')')),
                  (u = u || []),
                  w(this.important) && (h = !0);
              ...
              args: function (e) {
                ...
                for (;;) {
                  ...
                  if (d && d instanceof i.Variable)
                    if (w(':'))
                      t.length > 0 && (r && x('Cannot mix ; and , as delimiter types'), (a = !0)),
                        (c = S(this.expression)),
                        (l = f = d.name);
                    else {
                      if (!e && w(/^\.{3}/)) {
                  ...
                  if (w(',')) continue;
                  if (w(';') || r)
                    a && x('Cannot mix ; and , as delimiter types'),
                      (r = !0),
                      t.length > 1 && (c = new i.Value(t)),
                      n.push({ name: f, value: c }),
                      (f = null),
                      (t = []),
                      (a = !1);
                }
              ...
              definition: function () {
                ...
                if ((n = w(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/))) {
                  ...
                  (t = h.args),
                    ...
                    w(')') || ((l = o), g()),
                    w(this.comment),
                    w(/^when/) && (f = S(this.conditions, 'expected condition')),
                    (r = w(this.block));
            ...
            entity: function () {
              return (
                w(this.entities.literal) ||
                w(this.entities.variable) ||
                w(this.entities.url) ||
                w(this.entities.call) ||
                w(this.entities.keyword) ||
                w(this.entities.javascript) ||
                w(this.comment)
              );
            },
            end: function () {
            ...
            element: function () {
              ...
              (n = w(this.combinator)),
                (e =
                  ...
                  w(/^\([^()@]+\)/) ||
                  w(/^[\.#](?=@)/) ||
                  w(this.entities.variableCurly)),
                e || (w('(') && (r = w(this.selector)) && w(')') && (e = new i.Paren(r)));
            ...
            selector: function () {
              ...
              while ((u = w(this.extend)) || (t = w(this.element))) {
                u
                  ? a.push.apply(a, u)
                  : (a.length && x('Extend can only be used at the end of selector'),
                    (r = s.charAt(o)),
                    n.push(t),
                    (t = null));
                if (r === '{' || r === '}' || r === ';' || r === ',' || r === ')') break;
            ...
            rule: function (e) {
              ...
              if ((n = w(this.variable) || w(this.property))) {
                (r =
                  !e && (t.compress || n.charAt(0) === '@')
                    ? w(this.value) || w(this.anonymousValue)
                    : w(this.anonymousValue) || w(this.value)),
                  (a = w(this.important));
            ...
            condition: function () {
              ...
              if ((e = w(this.addition) || w(this.entities.keyword) || w(this.entities.quoted)))
                return (
                  (r = w(/^(?:>=|=<|[<=>])/))
                    ? (t = w(this.addition) || w(this.entities.keyword) || w(this.entities.quoted))
                      ? (n = new i.Condition(r, e, t, s, u))
                      : x('expected expression')
                    : (n = new i.Condition('=', e, new i.Keyword('true'), s, u)),
                  S(')'),
                  w(/^and/) ? new i.Condition('and', n, w(this.condition)) : n
                );
            },
            operand: function () {
              var e,
  ...
  (function (r) {
    ...
    (r.functions = {
      ...
      hsla: function (e, t, n, r) {
        function o(e) {
          return (
            (e = e < 0 ? e + 1 : e > 1 ? e - 1 : e),
            e * 6 < 1 ? s + (i - s) * e * 6 : e * 2 < 1 ? i : e * 3 < 2 ? s + (i - s) * (2 / 3 - e) * 6 : s
          );
        }
        (e = (f(e) % 360) / 360), (t = l(f(t))), (n = l(f(n))), (r = l(f(r)));
        var i = n <= 0.5 ? n * (t + 1) : n + t - n * t,
          s = n * 2 - i;
      ...
      overlay: function (e, t) {
        var n =
            e.rgb[0] < 128 ? (2 * e.rgb[0] * t.rgb[0]) / 255 : 255 - (2 * (255 - e.rgb[0]) * (255 - t.rgb[0])) / 255,
      ...
      hardlight: function (e, t) {
        var n =
            t.rgb[0] < 128 ? (2 * t.rgb[0] * e.rgb[0]) / 255 : 255 - (2 * (255 - t.rgb[0]) * (255 - e.rgb[0])) / 255,
      ...
      'data-uri': function (t, i) {
        ...
        var s = t.value,
          ...
          a = n('path'),
          f = !1;
        arguments.length < 2 && (o = s),
          this.env.isPathRelative(o) &&
            (this.currentFileInfo.relativeUrls
              ? (o = a.join(this.currentFileInfo.currentDirectory, o))
              : (o = a.join(this.currentFileInfo.entryPath, o)));
        ...
        if (v >= d) {
          if (this.env.ieCompat !== !1)
            return (
              ...
              new r.URL(i || t, this.currentFileInfo).eval(this.env)
            );
          this.env.silent ||
            console.warn("WARNING: Embedding %s (%dKB) exceeds IE8's data-uri size limit of %dKB!", o, v, d);
        }
        ...
        (e.Color.prototype = {
          ...
          toCSS: function (e, t) {
            ...
            var r = this.rgb
              .map(function (e) {
                return (
                  (e = Math.round(e)), (e = (e > 255 ? 255 : e < 0 ? 0 : e).toString(16)), e.length === 1 ? '0' + e : e
                );
              })
              .join('');
            return (
              n &&
                ((r = r.split('')),
                r[0] == r[1] && r[2] == r[3] && r[4] == r[5] ? (r = r[0] + r[2] + r[4]) : (r = r.join(''))),
              '#' + r
            );
          },
    ...
    (function (e) {
      (e.Dimension = function (n, r) {
        ...
        (e.Dimension.prototype = {
          ...
          operate: function (t, n, r) {
            ...
            if (n === '+' || n === '-') {
              ...
              n === '*'
                ? ((s.numerator = s.numerator.concat(r.unit.numerator).sort()),
                  (s.denominator = s.denominator.concat(r.unit.denominator).sort()),
                  s.cancel())
                : n === '/' &&
                  ((s.numerator = s.numerator.concat(r.unit.denominator).sort()),
                  (s.denominator = s.denominator.concat(r.unit.numerator).sort()),
                  s.cancel());
        ...
        (e.UnitConversions = {
          length: { m: 1, cm: 0.01, mm: 0.001, in: 0.0254, pt: 0.0254 / 72, pc: (0.0254 / 72) * 12 },
        ...
        (e.Unit.prototype = {
          ...
          toCSS: function (e) {
            return this.numerator.length >= 1
              ? this.numerator[0]
              : this.denominator.length >= 1
              ? this.denominator[0]
              : (!e || !e.strictUnits) && this.backupUnit
              ? this.backupUnit
              : '';
          },
          toString: function () {
          ...
          usedUnits: function () {
            ...
            for (n in e.UnitConversions)
              e.UnitConversions.hasOwnProperty(n) &&
                ((t = e.UnitConversions[n]),
                this.map(function (e) {
          ...
          cancel: function () {
            ...
            for (t in e)
              if (e.hasOwnProperty(t)) {
                var i = e[t];
                if (i > 0) for (n = 0; n < i; n++) this.numerator.push(t);
                else if (i < 0) for (n = 0; n < -i; n++) this.denominator.push(t);
              }
            this.numerator.length === 0 && this.denominator.length === 0 && r && (this.backupUnit = r),
              this.numerator.sort(),
    ...
    (function (e) {
      (e.Element = function (t, n, r) {
        (this.combinator = t instanceof e.Combinator ? t : new e.Combinator(t)),
          typeof n == 'string' ? (this.value = n.trim()) : n ? (this.value = n) : (this.value = ''),
          (this.index = r);
      }),
        (e.Element.prototype = {
          type: 'Element',
        ...
        (e.Attribute.prototype = {
          ...
          eval: function (t) {
            return new e.Attribute(
              this.key.eval ? this.key.eval(t) : this.key,
              this.op,
              this.value && this.value.eval ? this.value.eval(t) : this.value,
            );
          },
          toCSS: function (e) {
            var t = this.key.toCSS ? this.key.toCSS(e) : this.key;
            return (
              this.op && ((t += this.op), (t += this.value.toCSS ? this.value.toCSS(e) : this.value)), '[' + t + ']'
            );
          },
        }),
          ...
          eval: function (t) {
            ...
            return (
              ...
              this.value.length > 1
                ...
                : this.value.length === 1
                ? (this.value[0].parens && !this.value[0].parensInOp && (i = !0), (n = this.value[0].eval(t)))
                : (n = this),
              r && t.outOfParenthesis(),
              this.parens && this.parensInOp && !t.isMathOn() && !i && (n = new e.Paren(n)),
              n
            );
          },
          toCSS: function (e) {
        ...
        (e.Import.prototype = {
          ...
          eval: function (t) {
            ...
            return (
              ...
              n.evalImports(t),
              this.features ? new e.Media(n.rules, this.features.value) : n.rules
            );
          },
        });
    })(n('../tree')),
        ...
        (e.Media.prototype = {
          ...
          evalNested: function (t) {
            ...
            for (n = 0; n < i.length; n++)
              (r = i[n].features instanceof e.Value ? i[n].features.value : i[n].features),
    ...
    (function (e) {
      (e.mixin = {}),
                    ...
                    (i
                      ? i
                          .map(function (e) {
                            var t = '';
                            return (
                              e.name && (t += e.name + ':'), e.value.toCSS ? (t += e.value.toCSS()) : (t += '???'), t
                            );
                          })
                          .join(', ')
                      : '') +
        ...
        (e.mixin.Definition.prototype = {
          ...
          accept: function (e) {
            (this.params = e.visit(this.params)),
              (this.rules = e.visit(this.rules)),
                  ...
                  if (c) c = c.eval(t);
                    ...
                    if (!a[f].value)
                      throw {
                        type: 'Runtime',
                        message:
                          'wrong number of arguments for ' + this.name + ' (' + r.length + ' for ' + this.arity + ')',
                      };
          ...
          eval: function (t, n, r) {
            var i = [],
              ...
              l;
            return (
              o.rules.unshift(new e.Rule('@arguments', new e.Expression(i).eval(t))),
              (a = r ? this.parent.makeImportant.apply(this).rules : this.rules.slice(0)),
              (l = new e.Ruleset(null, a).eval(new e.evalEnv(t, [this, o].concat(s)))),
          ...
          matchCondition: function (t, n) {
            return this.condition &&
              !this.condition.eval(
                new e.evalEnv(
                  n,
                  [this.evalParams(n, new e.evalEnv(n, this.frames.concat(n.frames)), t, [])].concat(n.frames),
                ),
              )
              ? !1
              : !0;
    ...
    (function (e) {
      (e.Negative = function (e) {
        ...
        (e.Negative.prototype = {
          ...
          eval: function (t) {
            return t.isMathOn()
              ? new e.Operation('*', [new e.Dimension(-1), this.value]).eval(t)
              : new e.Negative(this.value.eval(t));
          },
        });
    })(n('../tree')),
    (function (e) {
      ...
      (e.Rule = function (t, n, r, i, s, o) {
        ...
        (e.Rule.prototype = {
          ...
          toCSS: function (e) {
            ...
            try {
              return (
                this.name + (e.compress ? ':' : ': ') + this.value.toCSS(e) + this.important + (this.inline ? '' : ';')
              );
            } catch (t) {
        ...
        (e.Ruleset.prototype = {
          ...
          eval: function (t) {
            ...
            for (var s = 0; s < r.rules.length; s++)
              r.rules[s] instanceof e.mixin.Call &&
                ((i = r.rules[s].eval(t).filter(function (t) {
                    ...
                    for (var o = 0; o < i.selectors.length; o++)
                      if ((s = t.match(i.selectors[o]))) {
                        t.elements.length > i.selectors[o].elements.length
                          ? Array.prototype.push.apply(r, i.find(new e.Selector(t.elements.slice(1)), n))
                          : r.push(i);
                        break;
                      }
                }),
          ...
          toCSS: function (t) {
            ...
            for (var f = 0; f < this.rules.length; f++) {
              ...
              if (a.rules || a instanceof e.Media) s.push(a.toCSS(t));
                ...
                if (a.name === '@charset') {
                  if (t.charset) {
                    a.debugInfo &&
                      (s.push(e.debugInfo(t, a)),
                      s.push(new e.Comment('/* ' + l.replace(/\n/g, '') + ' */\n').toCSS(t)));
                    continue;
                  }
                  t.charset = !0;
                }
            ...
            t.compress &&
              r.length &&
              ((a = r[r.length - 1]),
              a.charAt(a.length - 1) === ';' && (r[r.length - 1] = a.substring(0, a.length - 1))),
              (s = s.join(''));
            if (this.root) n.push(r.join(t.compress ? '' : '\n'));
            else if (r.length > 0) {
              (u = e.debugInfo(t, this)),
                (o = this.paths
                  .map(function (e) {
                    return e
                      .map(function (e) {
                    ...
                    for (o = 0; o < n.length; o++)
                      (c = n[o]),
                        ...
                        l.length > 0
                          ? ((h = l.slice(0)),
                            (m = h.pop()),
                            (d = new e.Selector(m.elements.slice(0), r.extendList)),
                            (v = !1))
                          : (d = new e.Selector([], r.extendList)),
          ...
          mergeElementsOnToSelectors: function (t, n) {
            ...
            for (r = 0; r < n.length; r++)
              (i = n[r]),
                i.length > 0
                  ? (i[i.length - 1] = new e.Selector(i[i.length - 1].elements.concat(t), i[i.length - 1].extendList))
      ...
      (e.debugInfo = function (t, n) {
        ...
        (e.debugInfo.asMediaQuery = function (e) {
          return (
            ...
            ('file://' + e.debugInfo.fileName).replace(/([.:/\\])/g, function (e) {
              return e == '\\' && (e = '/'), '\\' + e;
            }) +
        ...
        (e.visitor.prototype = {
          visit: function (e) {
            ...
            return (
              n &&
                ((r = { visitDeeper: !0 }),
                (i = n.call(this._implementation, e, r)),
                this._implementation.isReplacing && (e = i)),
              (!r || r.visitDeeper) && e && e.accept && e.accept(this),
              (t += 'Out'),
              this._implementation[t] && this._implementation[t](e),
              e
            );
          },
          ...
          visitImport: function (t, n) {
            ...
            if (!t.css) {
              try {
                ...
                s.filename || ((s.index = t.index), (s.filename = t.currentFileInfo.filename)),
                  (t.css = !0),
                  (t.error = s);
              }
              if (i && !i.css) {
          ...
          visitRuleset: function (t, n) {
            ...
            for (r = 0; r < t.paths.length; r++) {
              ...
              for (i = 0; i < u.length; i++)
                (this.foundExtends = !0),
                  (s = u[i]),
                  s.findSelfSelectors(a),
                  (s.ruleset = t),
                  i === 0 && (s.firstExtendOnThisSelectorPath = !0),
        ...
        (e.processExtendsVisitor.prototype = {
          run: function (t) {
            ...
            return (
              n.run(t),
              n.foundExtends
                ? ((t.allExtends = t.allExtends.concat(this.doExtendChaining(t.allExtends, t.allExtends))),
                  (this.allExtendsStack = [t.allExtends]),
            ...
            for (i = 0; i < t.length; i++)
              for (s = 0; s < n.length; s++) {
                ...
                (l = [h.selfSelectors[0]]),
                  (o = f.findMatch(c, l)),
                  o.length &&
                    c.selfSelectors.forEach(function (t) {
                      (a = f.extendSelector(o, l, t)),
                        (p = new e.Extend(h.selector, h.option, 0)),
                        (p.selfSelectors = a),
                        (a[a.length - 1].extendList = [p]),
                        u.push(p),
                        (p.ruleset = h.ruleset),
                        (p.parents = [h, c]),
                        h.firstExtendOnThisSelectorPath &&
                          ((p.firstExtendOnThisSelectorPath = !0), h.ruleset.paths.push(a));
                    });
              }
            if (u.length) {
          ...
          visitRuleset: function (e, t) {
            ...
            for (i = 0; i < s.length; i++)
              for (r = 0; r < e.paths.length; r++) {
                ...
                (n = this.findMatch(s[i], a)),
                  n.length &&
                    s[i].selfSelectors.forEach(function (e) {
          ...
          findMatch: function (e, t) {
            ...
            for (n = 0; n < t.length; n++) {
              ...
              for (i = 0; i < r.elements.length; i++) {
                (s = r.elements[i]),
                  (e.allowBefore || (n == 0 && i == 0)) &&
                    l.push({ pathIndex: n, index: i, matched: 0, initialCombinator: s.combinator });
                for (u = 0; u < l.length; u++)
                  (c = l[u]),
                    (o = s.combinator.value),
                    o == '' && i === 0 && (o = ' '),
                    !a.isElementValuesEqual(f[c.matched].value, s.value) ||
                    (c.matched > 0 && f[c.matched].combinator.value !== o)
                      ? (c = null)
                      : c.matched++,
                    c &&
                      ((c.finished = c.matched === f.length),
                      c.finished && !e.allowAfter && (i + 1 < r.elements.length || n + 1 < t.length) && (c = null)),
                    c
                      ? c.finished &&
                        ((c.length = f.length),
                        (c.endPathIndex = n),
                        (c.endPathElementIndex = i + 1),
                        (l.length = 0),
                        h.push(c))
                      : (l.splice(u, 1), u--);
              }
          ...
          isElementValuesEqual: function (t, n) {
            ...
            if (t instanceof e.Attribute)
              return t.op !== n.op || t.key !== n.key
                ? !1
                : !t.value || !n.value
                ? t.value || n.value
                  ? !1
                  : !0
                : ((t = t.value.value || t.value), (n = n.value.value || n.value), t === n);
            return !1;
          },
          extendSelector: function (t, n, r) {
            ...
            for (u = 0; u < t.length; u++)
              (l = t[u]),
                (a = n[l.pathIndex]),
                (f = new e.Element(l.initialCombinator, r.elements[0].value, r.elements[0].index)),
                l.pathIndex > i &&
                  s > 0 &&
                  ((o[o.length - 1].elements = o[o.length - 1].elements.concat(n[i].elements.slice(s))), (s = 0), i++),
                (o = o.concat(n.slice(i, l.pathIndex))),
                o.push(new e.Selector(a.elements.slice(s, l.index).concat([f]).concat(r.elements.slice(1)))),
                (i = l.endPathIndex),
                (s = l.endPathElementIndex),
                s >= a.elements.length && ((s = 0), i++);
            return (
              i < n.length &&
                s > 0 &&
                ((o[o.length - 1].elements = o[o.length - 1].elements.concat(n[i].elements.slice(s))), (s = 0), i++),
              (o = o.concat(n.slice(i, n.length))),
              o
            );
          },
          visitRulesetOut: function (e) {},
  ...
  (r.modifyVars = function (e) {
    ...
    (r.refresh = function (e) {
      var t, n;
      (t = n = new Date()),
        g(function (e, i, s, o, u) {
          if (e) return k(e, o.href);
          u.local
            ? C('loading ' + o.href + ' from cache.')
            : (C('parsed ' + o.href + ' successfully.'), S(i.toCSS(r), o, u.lastModified)),
            C('css for ' + o.href + ' generated in ' + (new Date() - n) + 'ms'),
            u.remaining === 0 && C('css generated in ' + (new Date() - t) + 'ms'),
            (n = new Date());
        }, e),
        m();
    }),
