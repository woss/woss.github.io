...
tags:
  ...
  - web development
  - portfolio
header_image: '[Space whale](/assets/spotify-library-sync/image%2010.png)'
---
...
![Cloud based instance. Create namespace](/assets/spotify-library-sync/image.png)

Cloud based instance. Create namespace

![Create new Database](/assets/spotify-library-sync/image%201.png)

Create new Database

Next step is to set up Database authentication

![image.png](/assets/spotify-library-sync/image%202.png)

Select `New system user`

![image.png](/assets/spotify-library-sync/image%203.png)

Create user and password

![image.png](/assets/spotify-library-sync/image%204.png)

## Step Four: Connect SurrealDB and n8n

Now, go to your n8n and create a credential. Search for SurrealDB

![image.png](/assets/spotify-library-sync/image%205.png)
...
![image.png](/assets/spotify-library-sync/image%206.png)
...
![Database design image with relations and table names.](/assets/spotify-library-sync/image%207.png)
...
![image.png](/assets/spotify-library-sync/image%208.png)
...
![image.png](/assets/spotify-library-sync/image%209.png)

Metrics are only available in the cloud, not in the Surrealist desktop

![image.png](/assets/spotify-library-sync/image%2010.png)

- Workflow screenshots

  ![image.png](/assets/spotify-library-sync/image%2011.png)

  ![image.png](/assets/spotify-library-sync/image%2012.png)

  ![image.png](/assets/spotify-library-sync/image%2013.png)

  ![image.png](/assets/spotify-library-sync/image%2014.png)

  ![image.png](/assets/spotify-library-sync/image%2015.png)
...
![image.png](/assets/spotify-library-sync/image%2016.png)
