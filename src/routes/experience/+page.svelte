    ...
    {:else}
      <div class="flex flex-col gap-0 mt-12">
        {#each entries as entry, i (entry.slug + entry.startDate)}
          <div
            class="grid grid-cols-[200px_1fr] gap-4 py-4 border-b border-[rgba(255,255,255,0.08)] last:border-b-0 items-start opacity-0 translate-y-2 transition-all duration-[400ms] max-md:grid-cols-1 max-md:gap-2 max-md:py-3"
          ...
          >
            <div class="flex flex-col gap-[1px] pt-[2px] pb-[2px] min-w-0">
            ...
            <div class="relative h-10 flex items-center max-md:h-6">
              <a
                ...
                class="absolute flex items-center h-5 no-underline cursor-pointer z-10 rounded-full overflow-hidden bg-primary opacity-35 transition-all duration-[250ms] hover:opacity-70 hover:shadow-[0_0_20px_rgba(0,255,136,0.15)] max-md:h-3"
