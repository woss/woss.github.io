...
{#if ready}
<ChatSidebar
 {chats} {canCreateChat} {showDeleteConfirm}
...
<div class="flex-1 flex flex-col min-w-0 max-md:px-4">
 ...
 <div class="flex-1 flex flex-col items-center justify-center gap-6 px-8 max-md:px-4 max-md:pt-9 max-md:justify-start">
 {#if canCreateChat}
