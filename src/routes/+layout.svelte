...
<nav
 ...
 class="fixed top-0 inset-x-0 h-(--nav-height) z-200 {isChatPage ? 'bg-transparent backdrop-blur-none border-b-0' : 'bg-surface/80 backdrop-blur-md border-b border-[rgba(255,255,255,0.08)] max-md:bg-transparent max-md:backdrop-blur-none max-md:border-b-0'}"
